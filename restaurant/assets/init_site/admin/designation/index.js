...
$(document).ready(function () {
    function resetForm() {
        $("#designationform").removeClass("was-invalid");
        ...
        $.ajax({
            ...
            success: function (response) {
                if (response.hasOwnProperty("errors")) {
                    $("#designationform").addClass("was-invalid");
                    $(".invalid-feedback").remove();
    ...
    function getDataTable() {
        ...
        if ($.fn.DataTable.isDataTable("#dataTable-designation")) {
            $("#dataTable-designation").DataTable().clear().destroy();
        }
        var dataTable = $("#dataTable-designation").DataTable({
            dom: "Blfrtip",
            stateSave: true,
            ...
            paging: true,
            ajax: {
                url: baseUrl + "/getDesignationList",
                type: "GET",
