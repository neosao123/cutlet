@extends('restaurant.layout.master', ['pageTitle'=>"View Restaurant Offer"])
@push('styles')
            ...
            <input type="hidden" name="code" value="{{ $restaurantcoupon->code }}" readonly>
				<div class="form-row">
					<div class="col-md-12 mb-3">
						...
						<input type="text" id="entityName" name="entityName" value="{{ $restaurantcoupon->entityName }}" readonly class="form-control-line">
					</div> 
				</div>
				<div class="form-row">
					<div class="col-md-4 mb-3">
						<label for="coupanCode">Coupon Code :<b style="color:red">*</b></label>
						<input type="text" id="couponCode" name="couponCode" value="{{ $restaurantcoupon->couponCode }}" readonly class="form-control-line" required readonly>
					</div> 
					<div class="col-md-4 mb-3">
						<label for="offerType">Offer Type :<b style="color:red">*</b></label>
						<select id="offerType" name="offerType" class="form-control-line" required readonly>
				    ...
				    <div class="col-md-4 mb-3">
						...
						<input type="number" id="perUserLimit" name="perUserLimit" readonly value="{{ $restaurantcoupon->perUserLimit }}" class="form-control-line" required>
					</div> 
				</div>
				<div class="form-row">
					<div class="col-md-4 mb-3">
						<label for="minimumAmount"> Minimum Amount : <b style="color:red">*</b></label>
						<input type="number" id="minimumAmount" readonly value="{{ $restaurantcoupon->minimumAmount }}" name="minimumAmount" class="form-control-line" required>
					</div> 
					<div class="col-md-4 mb-3 d-none" id="discountDiv">
						<label for="discount"> Discount (%): <b style="color:red">*</b></label>
						<input type="number" id="discount" readonly value="{{ $restaurantcoupon->discount }}" name="discount" class="form-control-line" required>
					</div> 
					<div class="col-md-4 mb-3" id="capDiv">
						<label for="capLimit"> Cap Limit : <b style="color:red">*</b></label>
						<input type="number" id="capLimit" readonly value="{{ $restaurantcoupon->capLimit }}" name="capLimit" class="form-control-line">
					</div> 	
					<div class="col-md-4 mb-3 d-none" id="flatAmountDiv">
                        <label for="flatAmount"> Flat Amount: <b style="color:red">*</b></label>
                        <input type="number" id="flatAmount" readonly name="flatAmount" class="form-control-line" value="{{ $restaurantcoupon->flatAmount }}">
                    </div>
				</div>
				<div class="form-row">
    				<div class="col-md-12 mb-3">
				...
				<div class="form-row">
					<div class="col-md-2 mb-3">
						...
						<select id="applyOn" name="applyOn" class="form-control-line" disabled>
					...
					<div class="col-md-10 mb-3 d-none" id="itemDiv">
						...
						<select class="form-control-line select2" name="offerItems[]" id="offerItems" multiple="multiple" disabled data-border-color="primary" data-border-variation="accent-2" style="width:100%">
								@if($items->count() > 0)
