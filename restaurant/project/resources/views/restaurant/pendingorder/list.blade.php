@extends('restaurant.layout.master', ['pageTitle'=>"Restaurant Pending Order List"])
@push('styles')
        ...
        <div class="d-flex align-items-center">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item"><a href="#">Pending Orders List</a></li>
            </ol>
          </nav>
        </div>
      </div>
      ...
      <div class="col-lg-12">
					...
					<div class="col-sm-3 form-group">
						...
						<div class="form-group">
						   <select class="select2 form-control"  style="width: 100%;" name="status" id="status">
								 ...
								 <option value="PLC">Pending</option>
        ...
        <div class="card">
          <div class="card-header">
            <div class="row">
              <div class="col-sm-6">
                <h5 class="mb-0" data-anchor="data-anchor">Pending Orders List</h5>
              </div>
            </div>
          </div>
          <div class="card-body">
            <div class="table-responsive">
              <table id="orderpending" class="table table-striped table-bordered nowrap">
                <thead>
                  <tr>
						<th>Sr. No</th>
						<th>Code</th>
...
@push('scripts')
  ...
  <script type="text/javascript" src="{{ asset('assets/init_site/restaurant/pendingorder/index.js') }}"></script>
