						...
						<hr>
							...
							<div class="text-xs-right">
							     @if($row->orderStatus=='PRE')
								      <button data-id="{{$row->code}}" data-action="Update order to ready for pickup?" data-status="RFP" class="actionBtn waves-effect waves-light btn btn-success mr-1">Ready For Pickup?</button>
							     @elseif($row->orderStatus=='RCH')
								      <button data-id="{{$row->code}}" data-action="Update order to ready for pickup?" data-status="RFP" class="actionBtn waves-effect waves-light btn btn-success mr-1">Ready For Pickup?</button>
								 @elseif($row->orderStatus=='PUP')
								      <div class="btn btn-success">On the Way</div>
								 @elseif($row->orderStatus=='DEL')
								      <div class="btn btn-success">Delivered</div>
								 @else
									 <div class="btn btn-success">Waiting for delivery boy pickup...</div>
								 @endif 
