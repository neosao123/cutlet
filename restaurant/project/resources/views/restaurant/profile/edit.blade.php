@extends('restaurant.layout.master', ['pageTitle' => 'Restaurant Profile View'])
@push('styles')
                ...
                <div class="d-flex align-items-center">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="#">Restaurant Profile View</a></li>
                        </ol>
                    </nav>
                </div>
            </div>
									...
									<form class="needs-validation" method="post" action="#" enctype="multipart/form-data" novalidate>
										<div class="row"> 
											...
											<div class="col-md-5 mb-3" id="cartPack" style="display:{{$restaurant->packagingType=='CART' ? 'block': 'none'}}">
												...
												<input type="number" id="cartPackagingPrice" maxlength="3" readonly name="cartPackagingPrice" class="form-control" {{$restaurant->packagingType=="CART"? 'required':''}} value="{{$restaurant->cartPackagingPrice}}">
											</div>											
										</div> 
									</form>
							</div>
