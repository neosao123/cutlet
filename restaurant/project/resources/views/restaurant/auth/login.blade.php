@extends('restaurant.auth.master', ['pageTitle' => 'Login'])
@push('styles')
        ...
        <div class="auth-box">
            <div id="loginform">
                <div class="logo">
                    ...
                    <h5 class="font-medium m-b-20 mt-2">Sign In to Restaurant</h5>
                        <?= env('ASSET_URL') ?>
						@if (session('fail'))
                ...
                <!-- Form -->
                 <div class="row">
                    <div class="col-12">
                        <form class="form-horizontal m-t-20" id="loginform" action="{{ url('/login-restaurant') }}" method="post">
                            @csrf
                            <div class="input-group mb-3">
                                <div class="input-group-prepend">
                                    <span class="input-group-text" id="basic-addon1"><i class="ti-user"></i></span>
                                </div>
                                <input type="text" name="mobile" class="form-control form-control-lg" placeholder="Mobile" required="" data-parsley-required-message="Mobile is required." value="{{ Cookie::get('mobile') }}" />
                            </div>
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="password" name="passwordR" class="form-control form-control-lg" placeholder="Password" aria-label="Password" aria-describedby="basic-addon1" required="" data-parsley-required-message="Password is required." value="{{ Cookie::get('passwordR') }}" />
                            </div>
