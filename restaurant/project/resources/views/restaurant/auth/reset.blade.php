@extends('restaurant.auth.master', ['pageTitle' => 'Reset Restaurant Login'])
@push('styles')
                       ...
                       <form class="col-12" action="{{ url('/recover-password') }}" data-parsley-validate="" method="post" id="resetpassword">
                        ...
                        <div class="form-group row">
                            <div class="col-12">
                                ...
                                <input type="text" name="password" id="password" class="form-control" type="password" required="" data-parsley-required-message="Password is required" maxlength="6">
                                <span class="text-center">{{ $errors->first('password') }}</span>
                            </div>
                            <div class="col-12">
                                <label>Confirm Password</label>
                                <input type="text" name="password_confirmation" id="password_confirmation" class="form-control" type="password" required="" data-parsley-required-message="Confirm Password is required" maxlength="6">
                                <span class="text-center">{{ $errors->first('password') }}</span>
                            </div>
                        </div>
                        <!-- pwd -->
