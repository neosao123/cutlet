@extends('restaurant.layout.master', ['pageTitle'=>"Welcome"])
@push('styles')
...
<link href="{{ asset('assets/init_site/restaurant/dashboard/index.css') }}" rel="stylesheet">
@endpush
@section('content')
  <div class="page-breadcrumb">
    <div class="row">
      <div class="col-7 align-self-center">
        <h4 class="page-title">Dashboard (Updates Every 60 sec)</h4>
