        ...
        <div class="card">
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col-sm-2">
                        <a href="{{ url('order/pendingList') }}" class="btn btn-outline-primary btn-sm"> Back </a>
                    </div>
                </div>
            </div>
            <div class="card-body">
				...
				@if($query)
					...
					<div class="form-row">
    					<div class="col-md-3 mb-3">
    					       ...
    					       <input type="hidden" id="resCode" name="resCode" class="form-control-line" value="{{ $row->restaurantCode}}" readonly>
						 </div>
    					<div class="col-md-3 mb-3">
						...
						<div class="form-row mt-2">
							<div class="float-left" style="width:50%;">
								@if($row->orderStatus !='RJT')
									<div class="col-md-12 mt-3 text-center">
										<label for="transferDeliveryBoy"><h3>Delivery Boy : <b style="color:black">({{ $row->name }})</b></h3></label>  <i class="fas fa-sync" id="pendingDBGet" style="font-size:20px" title="click here to get current available delivery boy"></i>
										@if($row->orderStatus !='DEL')
									...
									@if($row->orderStatus !='DEL')
										<div class="col-md-12 mt-5">							
											...
											<input type="checkbox" value="1" class="custom-control-input" style="width:40px;height:40px;" id="isExpired" name="isExpired" @if($row->isExpired == 1) "checked" @endif >
							...
							<div class="float-right" style="width:50%;">
								...
								<div class="col-md-6 offset-md-6">
									<b style="width:100%;"><label>Cutlet (-): </label><span class="float-right"><?= number_format($row->usedPoints, 2, '.', '') ?></span></b>
								</div>
								<div class="col-md-6 offset-md-6">
			 ...
			 <div class="card">
				<div class="card-header">
					<div class="row">
						<div class="col-sm-10">
							<h5 class="mb-0" data-anchor="data-anchor">Order Status List</h5>
						</div>
					</div>
				</div>
                <div class="card-body">
...
@push('scripts')
  ...
  <script type="text/javascript" src="{{ asset('assets/theme/dist/js/pages/datatable/datatable-basic.init.js') }}"></script>
    ...
    <script type="text/javascript" src="{{ asset('assets/theme/assets/libs/moment/min/moment.min.js') }}"></script>
	 <script type="text/javascript" src="{{ asset('assets/init_site/admin/orders/view.js') }}"></script>
