@extends('admin.layout.master', ['pageTitle'=> "Pending Orders List"])
@push('styles')
            ...
            <div class="card-header">
			 ...
			 <div class="card-body">
				<div class="row">
				   ...
				   <div class="col-sm-2 form-group mt-4 text-center">
...
@push('scripts')
  ...
  <script type="text/javascript" src="{{ asset('assets/init_site/admin/orders/pending.js') }}"></script>
