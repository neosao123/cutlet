@extends('admin.layout.master', ['pageTitle'=> "Cancel / Reject Orders List"])
@push('styles')
        ...
        <div class="d-flex align-items-center">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item"><a href="#">Cancel / Reject Orders List</a></li>
            </ol>
          </nav>
        </div>
      </div>
      ...
      <div class="col-lg-12">
		...
		<div class="card">
          <div class="card-header">
            <div class="row">
              <div class="col-sm-6">
                <h5 class="mb-0" data-anchor="data-anchor">Cancel / Reject Orders list</h5>
              </div>
            </div>
		 </div>
         <div class="card-body">
...
@push('scripts')
  ...
  <script type="text/javascript" src="{{ asset('assets/init_site/admin/orders/cancelOrder.js') }}"></script>
