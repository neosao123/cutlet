@extends('admin.layout.master', ['pageTitle'=>"City"])
@push('styles')
  <link href="{{ asset('assets/theme/assets/libs/datatables.net-bs4/css/dataTables.bootstrap4.css') }}" rel="stylesheet">
  <link href="{{ asset('assets/init_site/admin/city/index.css') }}" rel="stylesheet">
  ...
  <div class="container-fluid">
    <div class="row g-3 mb-3">
      <div class="col-lg-5">
        <div class="card">
          <div class="card-header">
            <h5 class="mb-0" data-anchor="data-anchor">City</h5>
          </div>
          <div class="card-body pt-0">
            <form id="cityform" class="" data-parsley-validate="">
              @csrf
              <input type="hidden" value="" name="code" id="code">
              <div class="mb-3">
                <label class="form-label" for="City">City Name</label>
                <input class="form-control" type="text" id="cityName" name="cityName" value="" placeholder="City Name" required="" data-parsley-required-message="City Name is required." />
      ...
      <div class="col-lg-7">
        <div class="card">
          <div class="card-header">
            <h5 class="mb-0" data-anchor="data-anchor">City List</h5>
          </div>
          <div class="card-body">
            <div class="table-responsive">
              <table id="dataTable-city" class="table table-striped table-bordered nowrap">
                <thead>
                  <tr>
                    <th>Sr. No. </th>
                    <th>Code</th>
...
@push('scripts')
  ...
  <script type="text/javascript" src="{{ asset('assets/init_site/admin/city/index.js') }}"></script>
@endpush
