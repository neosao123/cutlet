@extends('admin.layout.master', ['pageTitle'=>"Restaurant Item List"])
@push('styles')
    ...
    <div class="row">
      ...
      <div class="col-7 align-self-right">
		 <div class=" d-flex no-block justify-content-end align-items-center">
			<div class=""><a download class="btn btn-sm btn-warning" style="margin-right:5px;" href="{{ url('uploads/itemExcel/Restaurant Menu Item Excel.xlsx')}}">Get Excel Template</a></div>
			<div class=""><a class="btn btn-sm btn-success" style="margin-right:5px;" href="{{ url('restaurantItem/uploadExcel')}}">Upload Item Excel</a></div>
            <div class=""><a class="btn btn-sm btn-info"  style="margin-right:5px;" href="{{ url('restaurantItem/add') }}">Add New</a></div>
		</div>
      </div>
    </div>
  </div>
        ...
        @endif
		 ...
		 <div class="card">
          <div class="card-header">
            <div class="row">
              <div class="col-sm-6">
                <h5 class="mb-0" data-anchor="data-anchor">Restauarnt list</h5>
              </div>
            </div>
		 </div> 
          <div class="card-body">
