@extends('admin.layout.master', ['pageTitle'=>"Restaurant Slider"])
@push('styles')
  <link href="{{ asset('assets/theme/assets/libs/datatables.net-bs4/css/dataTables.bootstrap4.css') }}" rel="stylesheet">
  <link href="{{ asset('assets/init_site/admin/foodslider/index.css') }}" rel="stylesheet">
  ...
  <div class="page-breadcrumb">
    <div class="row">
      <div class="col-5 align-self-center">
        <h4 class="page-title">Restaurant Slider</h4>
        <div class="d-flex align-items-center">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item"><a href="#">Restaurant Slider List</a></li>
            </ol>
          </nav>
        </div>
      </div>
  ...
  <div class="container-fluid">
    <div class="row g-3 mb-3">
      <div class="col-lg-5">
        <div class="card">
          <div class="card-header">
            <h5 class="mb-0" data-anchor="data-anchor">Restaurant Slider</h5>
          </div>
          <div class="card-body pt-0">
            <form id="sliderform" class="" data-parsley-validate="">
			  ...
			  <div class="mb-3">
				<label class="form-label" for="sliderImage">Restaurant Slider Image</label>
      ...
      <div class="col-lg-7">
        <div class="card">
          <div class="card-header">
            <h5 class="mb-0" data-anchor="data-anchor">Restaurant Slider List</h5>
          </div>
          <div class="card-body">
...
@push('scripts')
  ...
  <script type="text/javascript" src="{{ asset('assets/init_site/admin/foodslider/index.js') }}"></script>
@endpush
