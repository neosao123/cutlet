@extends('admin.layout.master', ['pageTitle'=>"Restaurant List"])
@push('styles')
      ...
      <div class="col-lg-12">
			 ...
			 <div class="card-body">
				<div class="row">
				   ...
				   <div class="col-sm-3 form-group">
						...
						<div class="form-group">
						   <select class="select2 form-control custom-select" style="width: 100%;" name="ownername" id="ownername">
								 <option value="">Select</option>
								 @foreach($restaurant as $itemName)
								  <option value="{{$itemName->firstName}}_{{$itemName->lastName}}">{{$itemName->firstName}} {{$itemName->lastName}}</option>
								 @endforeach
						   </select>
						</div>
				   </div>
				   <div class="col-sm-3 form-group">
						...
						<div class="form-group">
						   <select class="select2 form-control custom-select" style="width: 100%;" name="city" id="city"> 
								 <option value="">Select</option>
				   ...
				   <div class="col-sm-3 form-group">
					   ...
					   <div class="form-group">
						  <select class="select2 form-control custom-select" style="width: 100%; height:36px;" name="serviceable" id="serviceable">
									<option value="">Select</option>
		...
		<div class="card">
          <div class="card-header">
            <div class="row">
              <div class="col-sm-6">
                <h5 class="mb-0" data-anchor="data-anchor">Restaurant list</h5>
              </div>
            </div>
		 </div>
         <div class="card-body">
            <div class="table-responsive">
              <table id="dataTable-Restaurant" class="table table-striped table-bordered nowrap">
                <thead>
                  <tr>
                    <th>Sr. No. </th>
...
@push('scripts')
  ...
  <script type="text/javascript" src="{{ asset('assets/init_site/admin/restaurant/index.js') }}"></script>
