@extends('admin.layout.master', ['pageTitle' => 'Restaurant Update'])
@push('styles')
...
@section('content')
                ...
                <div class="d-flex align-items-center">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="#">Restaurant Update</a></li>
                        </ol>
                    </nav>
                </div>
            </div>
    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header">
                <div class="row">
                    <div class="col-sm-10">
                        <h5 class="mb-0" data-anchor="data-anchor">Restaurant Update</h5>
                    </div>
                    <div class="col-sm-2">
            ...
            <div class="card-body">
                ...
                @endif
                <form action="{{ url('partner/update') }}" method="post" enctype="multipart/form-data" data-parsley-validate="">
                    @csrf
                    ...
                    <div class="form-row">
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" id="firstName" name="firstName" value="{{ $restaurant->firstName }}" class="form-control" required data-parsley-required-message="First Name is required"
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" id="middleName" name="middleName" value="{{ $restaurant->middleName }}" class="form-control" onkeypress="return ValidateAlpha(event)">
                            <span class="text-danger">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" id="lastName" name="lastName" value="{{ $restaurant->lastName }}" class="form-control" required data-parsley-required-message="Last Name is required"
                                onkeypress="return ValidateAlpha(event)">
                            <span class="text-danger">
                    ...
                    <div class="form-row">
                        <div class="col-md-3 mb-3">
                            ...
                            <input type="text" id="entityName" name="entityName" value="{{ $restaurant->entityName }}" class="form-control" required
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <input type="text" id="entityEmail" name="entityEmail" value="{{ $restaurant->email }}" class="form-control verify_owner_email"
                            ...
                            <div class="parsley-errors-list filled" id="shUpdateEmail"></div>
                        </div>
                        <div class="col-md-3 mb-3">
                        ...
                        @if (!empty($restaurant->entityImage))
                            <div class="col-md-3 mb-3" id="eImage">
                                <img class="img-thumbnail mb-2" width="100" height="100" id="showEntityImg" src="{{ url('uploads/restaurant/restaurantimage/' . $restaurant->entityImage) }}"
                                    data-src="">
                                <a class="btn btn-danger" onclick="deleteButton('entityImage','{{ $restaurant->code }}','{{ $restaurant->entityImage }}');"><i class="fa fa-trash"></i></a>
                            </div>
                        @endif
                        <div class="col-md-3 mb-3 d-none" id="eDisImage">
                            <img class="img-thumbnail mb-2" width="100" height="100" id="displayEntityImg" src="" data-src="">
                    ...
                    <div class="form-row">
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" id="ownerContact" name="ownerContact" value="{{ $restaurant->ownerContact }}" class="form-control verify_owner_mobile"
                                onkeypress="return isNumberKey(event)" maxlength="10" required="" data-parsley-required-message="Contact Number is required" pattern="[789][0-9]{9}"
                                data-parsley-pattern-message="Required Valid Mobile Number">
                            <span class="text-danger">
                                {{ $errors->first('ownerContact') }}
                            </span>
                            <div class="parsley-errors-list filled" id="shUpdateMobile"></div>
                        </div>

                        <div class="col-md-4 mb-3">
                            <label for="entityContact">Restaurant Contact : </label>
                            <input type="text" id="entityContact" name="entityContact" value="{{ $restaurant->entityContact }}" class="form-control" onkeypress="return isNumberKey(event)"
                    ...
                    <div class="form-row">
                        <div class="col-md-12 mb-3">
                            ...
                            <textarea type="text" id="address" name="address" class="form-control" rows="4" maxlength='800' data-parsley-minlength="10"
                                data-parsley-minlength-message="You need to enter at least 10 characters" data-parsley-trigger="change" required="" data-parsley-required-message="Address is required">{{ trim($restaurant->address) }}</textarea>
                            <span class="text-danger">
                    ...
                    <div class="form-row">
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" id="fssaiNumber" name="fssaiNumber" value="{{ $restaurant->fssaiNumber }}" class="form-control" required=""
                        ...
                        @if (!empty($restaurant->fssaiImage))
                            <div class="col-md-3 mb-3" id="fImage">
                                <img class="img-thumbnail mb-2" width="100" height="100" id="showfssaiImage" src="{{ url('uploads/restaurant/fssaiimage/' . $restaurant->fssaiImage) }}">
                                <a class="btn btn-danger" onclick="deleteButton('fssaiImage','{{ $restaurant->code }}','{{ $restaurant->fssaiImage }}');"><i class="fa fa-trash"></i></a>
                            </div>
                        @endif
                        <div class="col-md-3 mb-3 d-none" id="fDisImage">
                            <img class="img-thumbnail mb-2" width="100" height="100" id="displayFssaiImg" src="" data-src="">
                    ...
                    <div class="form-row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" id="latitude" name="latitude" class="form-control" step="any" required="" data-parsley-required-message="Latitude is required"
                                value="{{ $restaurant->latitude }}">
                        </div>

                        <div class="col-md-6 mb-3">
                            <label for="longitude"> Longitude : <b style="color:red">*</b></label>
                            <input type="number" id="longitude" name="longitude" class="form-control" step="any" required="" data-parsley-required-message="Longitude is required"
                    ...
                    <div class="row">
                        <div class="col-md-7 mb-3">
                            ...
                            <div class="custom-control custom-radio">
                                <input type="radio" id="cartPacking" name="packagingType" value="CART" class="custom-control-input" {{ $restaurant->packagingType == 'CART' ? 'checked' : '' }}>
                        ...
                        <div class="col-md-5 mb-3" id="cartPack" style="display:{{ $restaurant->packagingType == 'CART' ? 'block' : 'none' }}">
                            ...
                            <input type="number" id="cartPackagingPrice" name="cartPackagingPrice" value="{{ $restaurant->cartPackagingPrice }}" class="form-control" required=""
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-5 mb-3" id="gstPercentDiv" style="display:{{ $restaurant->gstApplicable == 'YES' ? 'block' : 'none' }}">
                            ...
                            <input type="number" step="0.01" maxlength="5" id="gstPercent" maxlength="3" name="gstPercent" class="form-control" value="{{ $restaurant->gstPercent }}"
                                {{ $restaurant->gstApplicable == 'YES' ? 'required' : '' }}>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="panNumber"> PAN Number :</label>
                            <div class="controls">
                                <input type="text" id="panNumber" name="panNumber" value="{{ $restaurant->panNumber }}" class="form-control">
                            </div>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="gstNumber"> GST Number :</label>
                            <div class="controls">
                                <input type="text" id="gstNumber" name="gstNumber" value="{{ $restaurant->gstNumber }}" class="form-control">
                            </div>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="commission"> Commission(%):</label>
                            <div class="controls">
                                <input type="number" step="0.01" maxlength="5" id="commission" name="commission" value="{{ $restaurant->commission }}" class="form-control">
                            </div>
                        </div>
                        ...
                        @if (!empty($restaurant->gstImage))
                            <div class="col-md-3 mb-3" id="gImage">
                                <img class="img-thumbnail mb-2" width="100" height="100" id="showgstImage" src="{{ url('uploads/restaurant/gstimage/' . $restaurant->gstImage) }}">
                                <a class="btn btn-danger" onclick="deleteButton('gstImage','{{ $restaurant->code }}','{{ $restaurant->gstImage }}');"><i class="fa fa-trash"></i></a>
                            </div>
                        @endif
                        <div class="col-md-3 mb-3 d-none" id="gDisImage">
                            <img class="img-thumbnail mb-2" width="100" height="100" id="displayGstImg" src="" data-src="">

                        </div>
                    </div>
                    <div class="form-row">
                        <input type="hidden" id="entityImageOld" name="entityImageOld" value="{{ $restaurant->entityImage }}" class="form-control" readonly>
                        <input type="hidden" id="fssaiImageOld" name="fssaiImageOld" value="{{ $restaurant->fssaiImage }}" class="form-control" readonly>
                        <input type="hidden" id="gstImageOld" name="gstImageOld" value="{{ $restaurant->gstImage }}" class="form-control" readonly>
                    </div>
                    <?php
                    ...
                    <div class="form-group">
                        <div class="custom-control custom-checkbox mr-sm-2">
                            ...
                            <input type="checkbox" value="1" class="custom-control-input" id="isActive" name="isActive" value="1" {{ $restaurant->isActive == 1 ? 'checked' : '' }}>
                            <label class="custom-control-label" for="isActive">Active</label>
                        </div>
                        @if ($restaurant->isServiceable == 1)
                            <span>As per Serviceable Restaurant is Open.</span>
                        @else
                            <span>As per Serviceable Restaurant is Closed. </span>
                        @endif
                        <div class="custom-control custom-checkbox mr-sm-2">

                            <input type="checkbox" value="1" class="custom-control-input" id="isServiceable" name="isServiceable" value="1"
                                @if ($resFlag == 0) {{ $restaurant->manualIsServiceable == 1 ? 'checked' : '' }}  onclick="return false;" @else {{ $restaurant->manualIsServiceable == 1 ? 'checked' : '' }} @endif>
    ...
    @endif		-->
                    ...
                    <div class="col-sm-12 form-group">
                        <button type="submit" class="btn btn-success btnsubmit" id="restaurant">Update</button>
                    </div>
            </div>
            </form>
        </div>
...
@push('scripts')
    ...
    <script type="text/javascript" src="{{ asset('assets/init_site/admin/restaurant/edit.js') }}"></script>
    <script type="text/javascript" src="{{ asset('assets/init_site/admin/restaurant/geomap-edit.js') }}" defer></script>
