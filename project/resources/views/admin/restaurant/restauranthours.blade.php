@extends('admin.layout.master', ['pageTitle' => 'Restaurant Hours'])
@push('styles')
        ...
        <div class="card">
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col-sm-2">
                        <a href="{{ url('partner/list') }}" class="btn btn-outline-success btn-sm"> Back </a>
                    </div>
                </div>
            </div>
            <div class="card-body">
...
@push('scripts')
  ...
  <script type="text/javascript" src="{{ asset('assets/init_site/admin/restaurant/hours.js') }}"></script>
