...
$('.pickatime').timepicker({
		...
		change: function() {
			...
			$.ajax({
				type: "get",
				url: baseUrl+"/partner/updateRestaurantHour",
				data: {'lineCode':lineCode,'time':time,'updateTo':updateto,'restCode':restCode,'weekDay':weekDay,'fromTime':fromTime,'toTime':toTime },
 ...
 function day_fields(day) {
	...
	//	debugger;
		if (flag == 'add') {
			...
			$.ajax({
				type: "get",
				url: baseUrl + "/partner/deleteHourLine",
				data: {
					"lineCode": code
				},
				success: function(response) {
